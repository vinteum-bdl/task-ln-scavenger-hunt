...
expected_chan_id=22643342462484480

wd=$(pwd)

# Execute lncli command and capture the output in a variable
lncli_output=$(lncli -n=signet --macaroonpath="$wd"/test/lnd0-readonly.macaroon --tlscertpath="$wd"/test/lnd0-tls.cert --rpcserver=185.215.164.89:10009 lookupinvoice --rhash="$rhash_value")
