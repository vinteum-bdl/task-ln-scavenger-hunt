...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    release_binary="lnd-linux-amd64-v0.20.0-beta"
elif [[ "$OSTYPE" == "darwin"* ]]; then
    release_binary="lnd-darwin-amd64-v0.20.0-beta"
else
...
wget "https://github.com/lightningnetwork/lnd/releases/download/v0.20.0-beta/$release_binary.tar.gz"
